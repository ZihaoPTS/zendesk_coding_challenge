...
def test_GetAllTickets():
    ...
    #can't creat double because essentially you have to retrieve the ticket through API
    credential = GetCredential()
...
def test_GetTicketsPrintout():
    #using previous saved tickets file
    with open('all_tickets.json') as f:
        AllTickets = json.load(f)['tickets']
